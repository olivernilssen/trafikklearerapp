...
export default class TabBarScreen extends Component {
    ...
    changeIndex = () => {
        ...
        if (this.tabbar) {
            do {
                index = Math.floor(
                    Math.random() * this.tabbar.props.children.length
                );
    ...
    getTabs(showAddTab: boolean) {
        const tabs = _.map(this.state.currentTabs, (tab) =>
            this.renderTabs(tab)
        );
    ...
    renderAddTabsTab() {
        return (
            <TabBar.Item
                key={'ADD_TABS'}
                label={
                    this.state.currentTabs.length >= 2 ? undefined : 'ADD TABS'
                }
            ...
            <ScrollView
                ...
                <View bg-dark80>
                    ...
                    >
                        ...
                        <TabBar.Item
                            label="Tab"
                            badgeProps={{ label: '100' }}
                            uppercase
                            style={{ backgroundColor: Colors.blue80 }}
                        />
                        <TabBar.Item
                            label="Bar"
                            uppercase
                    ...
                    <TabBar
                        ...
                        onChangeIndex={(index: number) =>
                            this.setState({ selectedIndex1: index })
                        }
                        indicatorStyle={{
